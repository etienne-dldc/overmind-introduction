...
<Appear>
  ...
  <Text>Build with TS, for TS 🚀</Text>
</Appear>
...
<Title>Libraries help us shapes <br /> the mental model of our apps</Title>
...
<Appear>
  ...
  <Text>Define what you app look like</Text>
...
<Appear>
  ...
  <Text>...except traking, so they appear in the devtool</Text>
</Appear>
...
<CodeSurfer
  ...
  steps={[
    {},
    { lines: [1], notes: "Import teh Derive type" },
...
<CodeSurfer
  ...
  steps={[
    ...
    { range: [9, 11] , notes: "Just copy past it once then forget it"},
    {},
  ]}
/>
