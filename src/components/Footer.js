  ...
  return (
    <Bottom>
      <Flex alignItems="center" p={2} pl={3} pr={3}>
        <Side>
          <Link mr={2} color="text" href="https://paris-ts.etienne-dot-js.com">
            paris-ts.etienne-dot-js.com
          </Link>
        ...
        <Side justifyContent="flex-end">
          <Link mr={2} color="text" href="https://paris-ts.etienne-dot-js.com/presentation.pdf">
            Download as PDF
          </Link>
        </Side>
      </Flex>
